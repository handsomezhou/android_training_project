...
public class Tetris extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		init_tetris();
		//LayoutInflater.from(getApplicationContext()).inflate(R.layout.activity_tetris, null);
	}
...
////				Toast.makeText(Tetris.this, "I'm gameView!",
////						Toast.LENGTH_SHORT).show();
////				System.out.println("I'm OnTouchListener");
//				
//				return true;
//			}
//		});
